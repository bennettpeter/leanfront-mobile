...
import org.mythtv.mobfront.data.VideoContract.VideoEntry;
import org.mythtv.mobfront.data.VideoContract.StatusEntry;
...
public class VideoDbHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "mobfront.db";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion < DATABASE_VERSION) {
            ...
            final String SQL_CREATE_VIDEO_TABLE = "CREATE TABLE " + VideoEntry.TABLE_NAME + " (" +
                    ...
                    VideoEntry.COLUMN_VIDEO_URL_PATH + " TEXT UNIQUE, " +
